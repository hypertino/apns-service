...
pomExtra :=
  <url>https://github.com/hypertino/apns-service</url>
    <licenses>
      <license>
        <name>BSD-style</name>
    ...
    <scm>
      <url>git@github.com:hypertino/apns-service.git</url>
      <connection>scm:git:git@github.com:hypertino/apns-service.git</connection>
    </scm>
    <developers>
      <developer>
        <id>horse315</id>
